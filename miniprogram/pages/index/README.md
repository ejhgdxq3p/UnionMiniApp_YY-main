...
**标签分组**：
- 💼 **专业领域**：软件与算法、硬件与工程、设计与体验、产品与商业、人文与跨界
- 🎨 **兴趣爱好**：创作与表达、游戏、身体与生活
- 🧠 **MBTI性格**：16种MBTI类型（单选）
- ✨ **性格关键词/星座/彩蛋**：性格关键词、星座、脑内小宇宙类、怪癖型生活习惯、神秘力量派、生活技能彩蛋、感性体验者、社交怪咖系、彩蛋型身份
...
### 新的5步流程：
- **第1步**：专业领域标签（必选）
  - 软件与算法：前端开发、后端开发、移动端开发、Web3/区块链、人工智能、数据科学、算法竞赛、大模型/AIGC、网络安全/渗透
  - 硬件与工程：嵌入式开发/单片机、电路设计、机器人、3D建模/打印、工业自动化、材料工程、可穿戴设备、通信/射频
  - 设计与体验：平面设计、UI/UX设计、产品/工业设计、动效设计、建筑/空间/展陈设计、交互艺术、游戏设计、服务设计
  - 产品与商业：产品经理、项目管理、品牌与增长、用研/市场分析、公共关系、一级市场投资、二级市场投资
  - 人文与跨界：心理学、教育学、社会学、法律/知识产权、艺术策展、哲学&思辨、科学传播、创业经验者

- **第2步**：兴趣爱好标签（必选）
  - 创作与表达：摄影&剪辑、绘画、写作、播客、乐器与歌唱、表演&舞台、模型佬、脑洞设定狂
  - 游戏：主机游戏、独立游戏、二次元、剧本杀、桌游/卡牌、音游
  - 身体与生活：烹饪/美食、宠物控、植物/园艺、跑步、徒步、健身、瑜伽/冥想、手工/DIY、穿搭/美学、收纳/整理
...
- **第4步**：个人信息设置（必填）
  - 显示名称、微信二维码、联系方式、个性标签、个人照片

- **第5步**：性格关键词/星座/彩蛋标签（可选）
  - 性格关键词：社牛、社恐、情绪稳定等16个选项
  - 星座：12星座选择
  - 彩蛋标签：脑内小宇宙类、怪癖型生活习惯、神秘力量派、生活技能彩蛋、感性体验者、社交怪咖系、彩蛋型身份等7个分类
...
- `personalityTags`: MBTI性格标签数组 (Array) - 单选，只包含1个MBTI类型
- `quirkyTags`: 性格关键词/星座/彩蛋标签数组 (Array) - 包含性格关键词、星座和彩蛋标签
...
### 编码相关字段（后台使用）
- `encodedTags`: 编码串（用于硬件设备，只包含前3页标签）
- `binaryArray`: 二进制数组（只包含前3页标签）
- `allTagsList`: 前3页标签列表（含分类信息）
- `selectedTags`: 用户实际选择的前3页标签名称数组
...
```json
{
  ...
  "advancedTags": {
    ...
    "interestTags": ["摄影&剪辑", "主机游戏", "烹饪/美食"],
    "personalityTags": ["INFP：理想主义者"],
    "quirkyTags": ["社恐", "天蝎座", "不喝咖啡活不了", "对颜色特别敏感"],
    "totalTags": 12,
    "threshold": 3,
    "displayName": "小明",
...
### 标签编码系统
```javascript
// 编码规则：只对前3页标签进行编码（专业领域、兴趣爱好、MBTI性格）
// 第5页彩蛋标签不参与编码
encoding: {
